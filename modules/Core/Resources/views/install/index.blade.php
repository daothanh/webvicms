...
@section('content')
    ...
    <div class="mt-5 mb-5 card">
        <h1 class="card-header">{{ __('Install') }}</h1>
        <div class="card-body">
            <h3>Website</h3>
            ...
            <div class="form-group">
                <label for="">{{ __('Database User') }}</label>
            ...
            <div class="form-group">
                <label for="">{{ __('Database Password') }}</label>
        ...
        <div class="card-footer">
            <div class="d-flex justify-content-end">
                {{ Form::submit(__('Install'), ['class' => 'btn btn-primary right']) }}
            </div>
        </div>
    </div>
    {{ Form::close() }}
