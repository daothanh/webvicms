...
Route::group(['prefix' => 'commerce'], function () {
    Route::group(['prefix' => '/products', 'middleware' => ['api.auth']], function () {
        ...
        ])->middleware('permission:commerce.product.list products');
        Route::post('delete/multiple', [
            'as' => 'api.commerce.product.delete-multiple',
            'uses' => 'ProductController@destroyMultiple',
        ])->middleware('permission:commerce.product.delete product');
        ...
        ])->middleware('permission:commerce.product.create product|commerce.product.edit product');
    ...
    Route::group(['prefix' => '/categories', 'middleware' => ['api.auth']], function () {
        ...
        ])->middleware('permission:commerce.product_category.list product categories');
        Route::post('delete/multiple', [
            'as' => 'api.commerce.category.delete-multiple',
            'uses' => 'CategoryController@destroyMultiple',
        ])->middleware('permission:commerce.product_category.delete product category');
        Route::delete('delete/{id}', [
        ...
        Route::post('store', [
            ...
            ->middleware('permission:commerce.product_category.create product category|commerce.product_category.edit product category');
        Route::post('restore/multiple', [
