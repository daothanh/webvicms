...
<div class="card">
    <div class="card-header">
        <div class="card-title">{{ __('blog::category.title.Create a category') }}</div>
    </div>
    <div class="card-body">
        @if(!empty($category))
                    ...
                    @if($hasMoreLanguages)
                        <div class="pt-3 tab-pane fade show @if($lang === $l) active @endif"
                            ...
                            <div class="form-group" id="{{ $lang.'_excerpt' }}">
                                <label>{{ trans('blog::category.labels.Excerpt', [], $lang) }}</label>
    ...
    <script>
        $(function () {
            ...
            $('#save-btn').click(function () {
                ...
                axios.post("{{ route('api.blog.category.store') }}", form)
                    .then(function (rs) {
                        window.location.href = "{{ route('admin.blog.category.index') }}";
                    })
