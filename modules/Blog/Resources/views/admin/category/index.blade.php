        ...
        <div class="card-body">
            ...
            <table id="data-table" class="table table-striped">
                ...
                <tr>
                    ...
                    <th width="100">{{ __('blog::category.labels.Status') }}</th>
                ...
                @if(count($categories))
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td>{{ $category->slug }}</td>
                            <td>
                                <input data-id="{{ $category->id }}" class="toggle-status" type="checkbox" name="status" @if($category->status === 1) checked @endif data-bootstrap-switch>
                            </td>
                            <td>
