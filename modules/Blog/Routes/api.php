...
Route::group(['prefix' => 'blog'], function () {
    Route::group(['prefix' => '/posts', 'middleware' => ['api.auth']], function () {
        ...
        ])->middleware(['api.permission:blog.post.list posts']);
        Route::post('delete/multiple', [
            'as' => 'api.blog.post.delete-multiple',
            'uses' => 'PostController@destroyMultiple',
        ])->middleware(['api.permission:blog.post.delete post']);
        Route::delete('delete/{id}', [
            'as' => 'api.blog.post.delete',
            'uses' => 'PostController@destroy',
        ])->where('id', '[0-9]+')->middleware(['api.permission:blog.post.delete post']);
        ...
        ])->middleware(['api.permission:blog.post.create post|blog.post.edit post']);
    ...
    Route::group(['prefix' => '/categories', 'middleware' => ['api.auth']], function () {
        ...
        ])->middleware(['api.permission:blog.post_category.list categories']);
        Route::post('delete/multiple', [
            'as' => 'api.blog.category.delete-multiple',
            'uses' => 'CategoryController@destroyMultiple',
        ])->middleware(['middleware' => 'api.permission:blog.post_category.delete category']);
        Route::delete('delete/{id}', [
            'as' => 'api.blog.category.delete',
            'uses' => 'CategoryController@destroy',
        ])->where('id', '[0-9]+')->middleware(['middleware' => 'api.permission:blog.post_category.delete category']);
        Route::post('force-delete/multiple', [
            'as' => 'api.blog.category.force-delete-multiple',
            'uses' => 'CategoryController@forceDestroyMultiple',
        ])->middleware(['middleware' => 'api.permission:blog.post.delete category']);
        Route::delete('force-delete/{id}', [
        ...
        ])->middleware(['middleware' => 'api.permission:blog.post_category.create category|blog.post_category.edit category']);
        Route::post('restore/multiple', [
