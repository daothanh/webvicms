...
$(document).ready(function () {
  ...
  function loadMedias() {
    ...
    page = parseInt(page);
    axios.get("".concat(MediaUrls.mediaGridSelectUrl, "?page=").concat(page, "&per_page=").concat(per_page)).then(function (rs) {
...
module.exports = __webpack_require__(/*! /Volumes/Data/www/webvicms/themes/Admin/resources/js/ckeditor-grid.js */"./resources/js/ckeditor-grid.js");
